വിഭാഗങ്ങൾ
/friendship    സൗഹൃദ കഥകള്‍              Analytics#categoryName::friendship      App#imageName::event_friendship.jpg          App#PratilipiList::{ "language":"MALAYALAM", "state":"PUBLISHED", "listName":"friendship" }
/love          പ്രണയ കഥകള്‍                   Analytics#categoryName::romance         App#imageName::romance.jpg          App#PratilipiList::{ "language":"MALAYALAM", "state":"PUBLISHED", "listName":"love" }
/mystery       ദുരൂഹ കഥകള്‍                  Analytics#categoryName::mystery   App#imageName::suspence.jpg         App#PratilipiList::{ "language":"MALAYALAM", "state":"PUBLISHED", "listName":"mystery" }
...
/memory        ഓര്‍മ്മക്കുറിപ്പുകള്‍                  Analytics#categoryName::experiences          App#imageName::experiences.jpg     App#PratilipiList::{ "language":"MALAYALAM", "state":"PUBLISHED", "listName":"memory" }
...
പ്രസിദ്ധമായവ
/event/poetry-contest കവിതാ മഹോത്സവം 	Analytics#categoryName::event-poetry-contest        App#imageName::fiction.jpg        App#PratilipiList::{ "language":"MALAYALAM", "state":"PUBLISHED", "eventId":6013749990260736 }
/event/loveudad  അച്ഛനെയാണെനിക്കിഷ്ടം 	Analytics#categoryName::event-loveudad        App#imageName::family.jpg        App#PratilipiList::{ "language":"MALAYALAM", "state":"PUBLISHED", "eventId":4530316151619584 }
